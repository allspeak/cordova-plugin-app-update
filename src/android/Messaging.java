...
public class Messaging 
{
     ...
     * Create a new plugin result and send it back to JavaScript
     */
    public static void sendErrorString2Web(CallbackContext callbackContext, String msg, int error_code) 
    {
        sendErrorString2Web(callbackContext, msg, error_code, true);
    }
